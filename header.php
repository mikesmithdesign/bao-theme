...
<head>
  ...
  list($footer_r, $footer_g, $footer_b) = sscanf(get_theme_mod('footer_text_color'), "#%02x%02x%02x"); ?>
    ...
    :root {
        ...
        ?>;
        --main-logo-size: <?php echo get_theme_mod('main_logo_size');
        ?>px;
        --scroll-logo-size: <?php echo get_theme_mod('scroll_logo_size');
        ?>px;
        --footer-logo-size: <?php echo get_theme_mod('footer_logo_size');
        ?>px;
    }
    </style>
    <meta name="theme-color" content="<?php echo get_theme_mod('site_bg_color'); ?>">
    <meta charset="utf-8" />
